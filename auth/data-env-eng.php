...
require_once "./config/db.php";
    ...
    $media_query = "SELECT filePath FROM media WHERE serviceID = '$serviceID'";
    ...
    $media_two_query = "SELECT filePath FROM media_two WHERE serviceID = '$serviceID'";
    ...
    $media_three_query = "SELECT filePath FROM media_three WHERE serviceID = '$serviceID'";
    ...
    $media_four_query = "SELECT filePath FROM media_four WHERE serviceID = '$serviceID'";
    ...
    $media_five_query = "SELECT filePath FROM media_five WHERE serviceID = '$serviceID'";
    ...
    $media_six_query = "SELECT filePath FROM media_six WHERE serviceID = '$serviceID'";
