...
<body>
    <div class="row g-0 justify-content-center bg-dark">
        <div class="col-md-6 col-lg-5 col-xl-5 position-fixed start-0 top-0 vh-100 overflow-y-hidden d-none d-lg-flex flex-lg-column">
            <div class="p-12 py-xl-10 px-xl-20">
                ...
                <div class="mt-16">
                    ...
                    <p class="text-white text-opacity-75 pe-xl-24">"Success is the sum of small efforts, repeated day in and day out." —Robert Collier</p>
                </div>
            </div>
            <div class="mt-auto ps-16 ps-xl-20">
                <img src="assets/img/password.webp" class="img-fluid rounded-top-start-4" width="400" alt="...">
            </div>
        </div>
