                ...
                <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
                    <div class="mb-6 mb-xl-10">
                        <div class="row g-3 align-items-center">
                            <div class="col">
                                <h3 class="ls-tight">Team</h3>
                            </div>
                            <div class="col">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-sm btn-dark d-sm-inline-flex" data-bs-target="#createNewTeamModal" data-bs-toggle="modal"><span class="pe-2"><i class="bi bi-plus-circle"></i> </span><span>Add New Team Member</span></button>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="table-responsive mb-10 mt-5">
                                            <table id="admins" class="table table-hover table-striped table-sm table-nowrap">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $admin_id = 1;
                                                    $select_query = "SELECT * FROM team ORDER BY dateCreated ASC";
                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        ...
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            $fullNamelength=20;
                                                            $fullName = substr($fullName, 0, $fullNamelength);
                                                    ?>
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <div class="align-items-center gap-3 ps-1">
